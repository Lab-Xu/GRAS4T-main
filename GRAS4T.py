...
from model_training import grassTop_training
...
def run(args, adata,
    ...
    grassTop_net = grassTop_training(params,
    ...
    if pretraining:
        ...
        grassTop_net.pretraining(nb_epochs_pretrain=nb_epochs_pretrain)
        input_embeds_pretraining = grassTop_net.get_embedding()
    ...
    best, best_t, mask, nan_happen = grassTop_net.major_training(
    ...
    input_embeds = grassTop_net.get_embedding(use_decoder=use_decoder_emb)
